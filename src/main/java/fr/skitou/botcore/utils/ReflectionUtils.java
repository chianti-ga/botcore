...
public class ReflectionUtils {
    ...
    /**
     * Detect all subtypes of {@code superClass} in the {@link Children#targetPackages()} package (and sub-packages), and get an instance for each of them.
     ...
     * @param superClass A class <b>ANNOTATED</b> by {@link Children} which will be searched for subtypes.
